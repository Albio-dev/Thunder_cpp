...
public:
  ...
  void frompath(std::string path) {
    ...
    this->value.clear();
    this->shape = {(unsigned short int)img.width(),
   ...
   */
  Images<T> max() { return NDArray<T>::max(prepareMat()); }
   ...
   */
  Images<T> min() { return NDArray<T>::min(prepareMat()); }
   ...
   */
  Images<T> sum() { return NDArray<T>::sum(prepareMat()); }
   ...
   */
  Images<T> mean() { return NDArray<T>::mean(prepareMat()); }
   ...
   */
  Images<T> std() { return NDArray<T>::std(prepareMat()); }
   ...
   */
  Images<T> var() { return NDArray<T>::var(prepareMat()); }
};