 ...
 * than a dimension, it cycles through the first returning the maximum along all
 * other dimensions.
 *
 ...
 * than a dimension, it cycles through the first returning the minimum along all
 * other dimensions.
 *
